...
produtoRouter.get('/cadastrar', ctrl.cadastroView);
produtoRouter.post("/cadastrar", upload.single("imagem"), ctrl.cadastrarProduto);
produtoRouter.post("/excluir", ctrl.excluirProduto);
produtoRouter.get("/alterar/:codigo", ctrl.alterarView);

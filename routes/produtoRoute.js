...
produtoRouter.get('/', auth.verificarUsuarioLogado, ctrl.listarView);
produtoRouter.get('/cadastrar', auth.verificarUsuarioLogado, ctrl.cadastroView);
produtoRouter.post("/cadastrar",auth.verificarUsuarioLogado,  upload.single("imagem"), ctrl.cadastrarProduto);
produtoRouter.post("/excluir", auth.verificarUsuarioLogado, ctrl.excluirProduto);
produtoRouter.get("/alterar/:codigo", auth.verificarUsuarioLogado, ctrl.alterarView);
produtoRouter.post("/alterar",auth.verificarUsuarioLogado,  upload.single("imagem"), ctrl.alterarProduto);
produtoRouter.get("/obter/:produto",auth.verificarUsuarioLogado,  ctrl.obter)
